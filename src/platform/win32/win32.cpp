...
static void ImGui_ImplWin32_UpdateMousePos() {
  ...
  POINT pos;
  // We take position even if  we don't have focus
...
#define IsWindows8Point1OrGreater()                                            \
  IsWindowsVersionOrGreater(HIBYTE(0x0602), LOBYTE(0x0602),                    \
...
void ImGui_ImplWin32_EnableDpiAwareness() {
  // if (IsWindows10OrGreater()) // This needs a manifest to succeed. Instead we
  // try to grab the function pointer!
  {
